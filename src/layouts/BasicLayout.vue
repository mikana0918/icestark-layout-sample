...
<template>
  <div class="menu">
    ...
    >
      ...
      <el-sub-menu index="/vue2">
        <template #title>
          <span>vue2 sample</span> 
        </template>
        <el-menu-item index="/vue2/options">vue2 Options</el-menu-item>
        <el-menu-item index="/vue2/class">Vue2 Class</el-menu-item>
        <el-menu-item index="/vue2/class-decorator">vue2 Class Decorator</el-menu-item>
      </el-sub-menu>
    </el-menu>
  </div>
</template>
